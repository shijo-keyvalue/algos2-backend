...
/**
 * Handles CRUD operations for GardenSite entities
 */
export class GardenSiteDao {
  ...
  public getAllGardenSites = async (searchParams: any): Promise<PaginationSupportedResponse> => {
